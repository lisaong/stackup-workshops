...
#define SWIGTYPE_p_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t swig_types[17]
...
#define SWIGTYPE_p_std__vectorT_std__vectorT_double_std__allocatorT_double_t_t_std__allocatorT_std__vectorT_double_std__allocatorT_double_t_t_t_t swig_types[24]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__mfcc

#else
#  define SWIG_init    init_mfcc

#endif
#define SWIG_name    "_mfcc"
...
#include "featurizer_16kPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_mfcc_Predict(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  void *arg1 = (void *) 0 ;
  std::vector< float,std::allocator< float > > *arg2 = 0 ;
  std::vector< float,std::allocator< float > > *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:mfcc_Predict",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0,SWIG_as_voidptrptr(&arg1), 0, 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "mfcc_Predict" "', argument " "1"" of type '" "void *""'"); 
  }
  {
    std::vector< float,std::allocator< float > > *ptr = (std::vector< float,std::allocator< float > > *)0;
    res2 = swig::asptr(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "mfcc_Predict" "', argument " "2"" of type '" "std::vector< float,std::allocator< float > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "mfcc_Predict" "', argument " "2"" of type '" "std::vector< float,std::allocator< float > > const &""'"); 
    }
    arg2 = ptr;
  }
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_std__vectorT_float_std__allocatorT_float_t_t,  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "mfcc_Predict" "', argument " "3"" of type '" "std::vector< float,std::allocator< float > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "mfcc_Predict" "', argument " "3"" of type '" "std::vector< float,std::allocator< float > > &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< float,std::allocator< float > > * >(argp3);
  mfcc_Predict(arg1,(std::vector< float,std::allocator< float > > const &)*arg2,*arg3);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"mfcc_Predict", _wrap_mfcc_Predict, METH_VARARGS, (char *)"\n"
...
static swig_cast_info _swigc__p_ell__api__CallbackForwarderT_float_float_t[] = {  {&_swigt__p_ell__api__CallbackForwarderT_float_float_t, 0, 0, 0},{0, 0, 0, 0}};
